  ...
  return (
    ...
    <div className="flex flex-col max-w-screen-2xl mx-auto">
      ...
      <div>
        ...
        <p className="font-dm text-justify pt-[10px] md:pt-[20px] lg:pt-[40px] max-w-sm md:max-w-full lg:max-w-screen-2xl text-[#6F6F6F] text-xs lg:text-lg">
        ...
        <p className="font-dm text-justify pt-[10px] md:pt-[15px] lg:pt-[40px] max-w-sm md:max-w-full lg:max-w-screen-2xl text-[#6F6F6F] text-xs lg:text-lg">
