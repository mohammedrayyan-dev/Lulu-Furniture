...
const MadeForYou = () => {
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 max-w-7xl mx-auto lg:mt-[50px] lg:mb-[50px] justify-center md:flex-row lg:flex-row md:gap-4 lg:gap-10 py-8 lg:py-0">
