...
const WhatMakesUsDifferent = () => {
  return (
    ...
    <div className="flex flex-col mt-[40px] lg:mb-[50px] lg:w-full max-w-screen-2xl mx-auto gap-4 lg:gap-7">
        ...
        <p className="text-[#6F6F6F] text-justify font-dm max-w-sm md:max-w-full lg:max-w-screen-2xl text-xs lg:text-lg">
        ...
        <div className="mx-auto pt-[22px] lg:pt-[32px] aspect-[16/10] max-w-full md:max-w-[600px] lg:max-w-[905px]">
        <img src={HeroBanner2} 
        alt="Hero Banner" 
