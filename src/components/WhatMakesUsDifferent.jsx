...
const WhatMakesUsDifferent = () => {
  return (
    ...
    <div className="flex flex-col mt-[40px] lg:mb-[50px] lg:w-full max-w-7xl mx-auto gap-4 lg:gap-7">
        ...
        <p className="text-[#6F6F6F] text-justify font-dm max-w-sm md:max-w-full lg:max-w-7xl text-xs lg:text-lg">
