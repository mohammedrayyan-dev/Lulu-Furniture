...
const EngineeredWoodBedCots = () => {
    ...
    useEffect(() => {
        document.title = "Engineered Wood Bed Cots | Lulu Furniture";
    }, []);
  ...
  return (
    ...
    <div className="flex flex-col mt-6 lg:mt-8 items-center gap-6 lg:gap-8">
        ...
        {EngineeredWoodBedCotsCollections.map((item) => (
        <div 
...
export default EngineeredWoodBedCots;