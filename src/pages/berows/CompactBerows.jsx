...
const CompactBerowsCollections = [
    { name: "Wall Mounted", image: BlackPU, alt: "Wall Mounted" },
    { name: "Foldable", image: BrownPU, alt: "Foldable" },
    { name: "Corner Fit", image: CreamPU, alt: "Corner Fit" },
]

const CompactBerows = () => {

    useEffect(() => {
        document.title = "Compact Berows | Lulu Furniture";
    }, []);
  ...
  return (
    ...
    <div className="flex flex-col mt-6 lg:mt-8 items-center gap-6 lg:gap-8">
        ...
        {CompactBerowsCollections.map((item) => (
        <div 
