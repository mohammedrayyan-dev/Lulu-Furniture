...
const DiningChairsCollections = [
    { name: "Wooden Dining", image: BlackPU, alt: "Wooden Dining" },
    { name: "Cushioned Dining", image: BrownPU, alt: "Cushioned Dining" },
    { name: "Metal Dining", image: CreamPU, alt: "Metal Dining" },
]

const DiningChairs = () => {

    useEffect(() => {
        document.title = "Dining Chairs | Lulu Furniture";
    }, []);
  ...
  return (
    ...
    <div className="flex flex-col mt-6 lg:mt-8 items-center gap-6 lg:gap-8">
        ...
        {DiningChairsCollections.map((chair) => (
        <div 
