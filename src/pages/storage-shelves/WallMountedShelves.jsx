...
const WallMountedShelvesCollections = [
    { name: "Single Plank", image: BlackPU, alt: "Single Plank" },
    { name: "Floating Set", image: BrownPU, alt: "Floating Set" },
    { name: "Zigzag Shelves", image: CreamPU, alt: "Zigzag Shelves" },
]

const WallMountedShelves = () => {

    useEffect(() => {
        document.title = "Wall Mounted Shelves | Lulu Furniture";
    }, []);
  ...
  return (
    ...
    <div className="flex flex-col mt-6 lg:mt-8 items-center gap-6 lg:gap-8">
        ...
        {WallMountedShelvesCollections.map((item) => (
        <div 
...
export default WallMountedShelves;