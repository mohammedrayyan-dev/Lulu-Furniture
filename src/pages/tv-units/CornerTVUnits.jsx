...
const CornerTVUnitsCollections = [
    { name: "L-Shape Corner", image: BlackPU, alt: "L-Shape Corner" },
    { name: "Wooden Corner", image: BrownPU, alt: "Wooden Corner" },
    { name: "Compact Corner", image: CreamPU, alt: "Compact Corner" },
]

const CornerTVUnits = () => {

    useEffect(() => {
        document.title = "Corner TV Units | Lulu Furniture";
    }, []);
  ...
  return (
    ...
    <div className="flex flex-col mt-6 lg:mt-8 items-center gap-6 lg:gap-8">
        ...
        {CornerTVUnitsCollections.map((tv) => (
        <div 
